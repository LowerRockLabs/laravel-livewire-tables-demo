<div class="pb-6 border-b border-white">
    ...
    <button class="p-2 border border-white rounded" wire:click="$emit('setFilter', 'active', '1')">Filter Active
        Yes</button>
    <button class="p-2 border border-white rounded" wire:click="$emit('setFilter', 'active', '0')">Filter Active
        No</button>
